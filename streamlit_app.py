...
# Função para baixar e processar dados de um mês específico sem aplicar o filtro
...
# Função para carregar todos os dados do ano, mês a mês, sem filtro de CNPJ
@st.cache_data(show_spinner=False)
...
# Carregar os dados do ano completo e armazená-los em cache
dados_ano_total = carregar_dados_ano(ano)

# Filtrar os dados pelo CNPJ especificado sem recarregar os dados brutos
